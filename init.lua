...
vim.keymap.set('n', '<leader>vc', function()
  vim.cmd 'edit ~/.config/nvim/init.lua' -- or change to 'config.lua' if that's your entry point
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      require('toggleterm').setup {
        open_mapping = [[<c-\>]],
        direction = 'horizontal', -- change to 'float' | 'tab' | 'vertical' if preferred
  ...
  },
  {
    ...
    config = function()
      ...
      end, { desc = 'Telescope ToggleTerm Manager' })
    end,
  },
  -- LSP Plugins
  {
